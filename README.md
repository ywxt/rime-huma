...
- Emoji: 快捷鍵 `Alt + Shift + E` 切換 emoji 顯示。

- Unicode 碼位：顯示 Unicode 碼點與碼段。

- 日文模式：假名（羅碼字）+ 日本新字體漢字，全局快捷鍵 `Alt + Shift + J` 。
